            ...
            <div className="h-16 w-full bg-white/[0.04] backdrop-blur-[20px] border border-white/[0.08] rounded-[20px] shadow-[0_10px_40px_rgba(0,0,0,0.5)] flex items-center justify-between px-5">
                <div className="flex items-center group">
                    <img
                        ...
                        alt="StudioX"
                        draggable="false"
                        className="h-10 md:h-11 w-auto object-contain filter drop-shadow-[0_0_18px_rgba(255,255,255,0.3)] transition-all duration-500 group-hover:scale-105 select-none"
                    />
                </div>

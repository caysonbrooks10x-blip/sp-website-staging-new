        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 md:gap-10 mb-12 md:mb-16">
          <div className="space-y-4 md:space-y-6 max-w-3xl">
            <div className="flex items-center gap-3 hero-text transform-gpu">
              ...
              <span className="text-xs font-medium tracking-[0.3em] uppercase text-cyan-300/90">The Gallery</span>
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight text-white hero-text leading-[1.05] md:leading-[0.9] transform-gpu">
              Community <br className="hidden md:block" />
              <span className="font-serif italic text-zinc-500">Perspectives</span>
            </h1>
            <p className="text-base md:text-lg text-zinc-400 max-w-xl hero-text pt-2 md:pt-4 leading-relaxed transform-gpu truncate-multiline">
